...
import top.ilov.mcmods.ekac.items.materials.ekaCMaterials;

public class ekaCItemsRegistry {

    public static final Item ekac_hat = registerItem("ekac_hat", new ArmorItem(ekaCMaterials.ekac, EquipmentSlot.HEAD,
